...
class DenseGrid(nn.Module):
    def __init__(self, channels=None, world_size=None, xyz_min=None, xyz_max=None, path=None, **kwargs):
        ...
        if path is not None:
            ...
            self.grid = st['model_state_dict']['k0.grid']
            self.xyz_min = st['model_state_dict']['xyz_min']
            self.xyz_max = st['model_state_dict']['xyz_max']
