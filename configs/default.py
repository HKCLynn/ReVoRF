...
coarse_train = dict(
    ...
    ug_scale=[],
    pg_scale=[1000, 2000, 3000, 4000],                  # checkpoints for progressive scaling
    ...
    weight_tv_density=0.0005,        # weight of total variation loss of density voxel grid
    weight_tv_k0=0.00005,             # weight of total variation loss of color/feature voxel grid
    weight_warp_rgb=0.1,
    weight_warp_depths=0.001,
...
fine_train.update(dict(
    N_iters=10000,
    pervoxel_lr=False,
    normal_patch_num = 250,
    ray_sampler='patch',
    
    weight_entropy_ray=0.00,
    weight_entropy_volume=0.00,
    weight_entropy_xyz = 0.000,
    patch_size=6,
    N_rand_sample = 16384,
    ...
    ug_scale=[5000, 6000, 7000, 8000],
    
    
    
    
    weight_tv_depth=0.00005,
    weight_depths = 0.05,
    weight_tv_density=0.00005,        # weight of total variation loss of density voxel grid
    weight_tv_k0=0.00001,             # weight of total variation loss of color/feature voxel grid
    set_lr = True,
))
